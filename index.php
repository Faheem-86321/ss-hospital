...
$page_name = $_GET['page'];
$possible_files = [
    "web_temp/" . $page_name . ".html.php",
    "web_temp/" . strtolower($page_name) . ".html.php",
    "web_temp/" . ucfirst(strtolower($page_name)) . ".html.php",
    "web_temp/" . strtoupper($page_name) . ".html.php",
];
...
if($page_file) {
    ...
    // Page not found - show 404 with debugging info
    ?>
    <!DOCTYPE html>
    <html>
    <head>
    ...
    <body>
        ...
        <div class="debug">
            ...
            <p><strong>Looking for:</strong> <?php echo htmlspecialchars($page_name); ?></p>
